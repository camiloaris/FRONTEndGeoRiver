...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9098788.748735, -470925.801418, 1804280.292601, 1984870.725021], maxZoom: 28, minZoom: 1, projection: 'EPSG:3857'
    })
});

map.getView().fit([-9098788.748735, -470925.801418, 1804280.292601, 1984870.725021], map.getSize());
